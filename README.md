...
## So I built Scylla. One command, all protocols, parallel.
...
scylla 10.0.0.5 -u admin -p Password123 --protocols smb,winrm,rdp

# Multiple targets from file, multiple creds
scylla targets.txt -c creds.txt

# NTLM hash auth
scylla 10.0.0.5 -u admin -H aad3b435b51404eeaad3b435b51404ee:8846f7eaee8fb117ad06bdd830b7586c

# No credentials (null/anonymous probe)
scylla 10.0.0.5

# Extra detail per protocol
scylla 10.0.0.5 -u admin -p Password123 -v

# Full raw nxc output per protocol
scylla 10.0.0.5 -u admin -p Password123 -vv

# JSON output for automation
scylla 10.0.0.5 -u admin -p Password123 --json
...
Contact : [hello@phyozinkhant.dev](mailto:hello@phyozinkhant.dev) </br>
Portfolio : [www.phyozinkhant.dev](https://www.phyozinkhant.dev) </br>
Github : [@NitelPhyoe](https://github.com/NitelPhyoe) </br>
